...
/** Em prod (Render): `VITE_API_BASE_URL`. Em dev: vazio → `/api` com proxy do Vite. */
...
/** ms; 0 = sem polling automático (só mount + invalidação manual). Vite: VITE_REFETCH_* */
    ...
    <div className="wx">
      ...
      <footer className="wx-footer">
        <div className="wx-footer-inner">
          <p className="wx-footer-k">WHACKED</p>
          <p className="wx-footer-copy">© 2026 Whacked. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
